...
// 1. Explicitly import all model definer functions
...
const messageDefiner = require('./Message'); // This line was missing
...
db.Message = messageDefiner(sequelize, Sequelize.DataTypes); // This line was missing
